...
public:
    ...
    void retranslateUi(QWidget *Counter)
    {
        ...
        button->setText(QApplication::translate("Counter", "START", 0, QApplication::UnicodeUTF8));
